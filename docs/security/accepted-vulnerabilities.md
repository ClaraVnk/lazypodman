...
| [GO-2026-5617](https://pkg.go.dev/vuln/GO-2026-5617) | `github.com/docker/docker` | `v28.5.2+incompatible` | No upstream fix | Newly disclosed in the inherited Docker SDK; no fix available. Same root cause and removal path as the other `docker/docker` entries (ADR 0002, Phase 6). |
| [GO-2026-5668](https://pkg.go.dev/vuln/GO-2026-5668) | `github.com/docker/docker` | `v28.5.2+incompatible` | No upstream fix | Same as above — reachable via the inherited Docker SDK code path. |
| [GO-2026-5746](https://pkg.go.dev/vuln/GO-2026-5746) | `github.com/docker/docker` | `v28.5.2+incompatible` | No upstream fix | Same as above — reachable via the inherited Docker SDK code path. |
