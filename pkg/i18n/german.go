...
func germanSet() TranslationSet {
	return TranslationSet{
		...
		ErrorOccurred:                     "Es ist ein Fehler aufgetreten! Bitte erstelle ein Issue hier: https://github.com/ClaraVnk/lazypodman/issues",
		ConnectionFailed:                  "Verbindung zum {{engine}} Client fehlgeschlagen. Du musst ggf. den {{engine}} Client neustarten.",
