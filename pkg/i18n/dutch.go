...
func dutchSet() TranslationSet {
	return TranslationSet{
		...
		ErrorOccurred:                     "Er is iets fout gegaan! Zou je hier een issue aan willen maken: https://github.com/ClaraVnk/lazypodman/issues",
		ConnectionFailed:                  "connectie naar de {{engine}} client mislukt. Het zou kunnen dat je de {{engine}} client moet herstarten",
