...
func turkishSet() TranslationSet {
	return TranslationSet{
		...
		ErrorOccurred:                     "Bir hata oluştu! Lütfen https://github.com/ClaraVnk/lazypodman/issues adresinden bir hataya ilişkin konu oluşturun",
		ConnectionFailed:                  "{{engine}} bağlantısı başarısız oldu. {{engine}}' ı yeniden başlatmanız gerekebilir",
