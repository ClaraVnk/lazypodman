...
func portugueseSet() TranslationSet {
	return TranslationSet{
		...
		ErrorOccurred:                     "Um erro ocorreu! Por favor, crie uma issue em https://github.com/ClaraVnk/lazypodman/issues",
		ConnectionFailed:                  "Falha na conexão com o cliente {{engine}}. Você pode precisar reiniciar o seu cliente {{engine}}",
