...
func frenchSet() TranslationSet {
	return TranslationSet{
		...
		ErrorOccurred:              "Une erreur s'est produite ! Veuillez créer un rapport d'erreur sur https://github.com/ClaraVnk/lazypodman/issues",
		ConnectionFailed:           "Erreur lors de la connexion au client {{engine}}. Essayez de redémarrer votre client {{engine}}",
